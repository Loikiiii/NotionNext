...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Agoin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的学生仔', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Agoin12.com', // 网站地址
